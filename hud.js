  ...
  */
  ...
  this.render = function() {
    ...
    if(scoreString > 2000) {
      ...
      textSize(12);
      fill(255);
      text("Dat heb je goed gedaan, de professor verwacht je.",(width / 4) - 100, height / 4);
      text( "Zorg dat je de oplossing van dit raadsel weet als je durft te komen.", (width / 4) - 100, height /3 );
      text(" Geef mij te eten en ik leef, geef mij te drinken en ik sterf.  Wat ben ik?", (width / 4) - 100, height / 2);
    }
  }
